 ...
 * 
 * Time Complexity:
 *  - Best Case: O(d * (n + k)) (where d is the number of digits, n is number of elements, k is the base (e.g. 10))
 *  - Average Case: O(d * (n + k))
 *  - Worst Case: O(d * (n + k))
 * 
 * Space (Memory) Complexity: O(n + k) (requires auxiliary arrays for counting sort subroutine)
 */
